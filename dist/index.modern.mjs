...
const mouseEventTypes = ['click', 'rightclick', 'contextmenu', 'dblclick', 'mousemove', 'mouseout', 'mouseover'];
...
const _excluded = ["onClick", "onDrag", "onDragStart", "onDragEnd", "onMouseOver", "onMouseOut", "onRightClick", "children"];
function useMarker(props) {
  ...
  }, [marker, draggable, onClick, onDrag, onDragStart, onDragEnd, onMouseOver, onMouseOut, onRightClick]);
